 ...
 * @author 490501
 */
public class SmallHouse extends StandartUnit{

    public SmallHouse(String name, double area, double equipment, double light, double warm, double operationTimeHours, double operationTimeDays, double operationTimeWeeks) {
        super(name, area, equipment, light, warm, operationTimeHours, operationTimeDays, operationTimeWeeks);
    }

    public SmallHouse(double area) { // tall tatt av Standard Norge
        super(area);
